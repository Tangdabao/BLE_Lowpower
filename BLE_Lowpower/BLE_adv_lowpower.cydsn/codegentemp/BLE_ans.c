...
const CYBLE_ANSS_T cyBle_anss =
{
    0x0010u,    /* Handle of the ANS service */
    {
        ...
        {
            CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Supported New Alert Category characteristic */ 
        ...
        {
            CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Supported Unread Alert Category characteristic */ 
        ...
        {
            CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Unread Alert Status characteristic */ 
        ...
        {
            CYBLE_GATT_INVALID_ATTR_HANDLE_VALUE, /* Handle of the Alert Notification Control Point characteristic */ 
