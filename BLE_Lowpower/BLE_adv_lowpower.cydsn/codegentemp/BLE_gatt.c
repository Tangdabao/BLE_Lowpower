    ...
    const CYBLE_GATTS_T cyBle_gatts =
{
    ...
    /* Device Name */
    (uint8)'B', (uint8)'L', (uint8)'E', (uint8)'_', (uint8)'L', (uint8)'o', (uint8)'w', (uint8)'p', (uint8)'o',
    (uint8)'w', (uint8)'e', (uint8)'r',
    ...
    0x28u, 0x00u, 0x38u, 0x00u, 0x00u, 0x00u, 0x50u, 0x00u,
...
const CYBLE_GATTS_DB_T cyBle_gattDB[0x13u] = {
    ...
    { 0x0010u, 0x2800u /* Primary service                     */, 0x00000001u /*       */, 0x0013u, {{0x1811u, NULL}}                           },
