...
CYBLE_GAPP_DISC_PARAM_T cyBle_discoveryParam =
{
    ...
    {0x56u, 0x34u, 0x12u, 0x50u, 0xA0u, 0x00u}, /* uint8* direct_addr */
...
CYBLE_GAPP_DISC_DATA_T cyBle_discoveryData =
{
    ...
    0x45u, 0x5Fu, 0x4Cu, 0x6Fu, 0x77u, 0x70u, 0x6Fu, 0x77u,
    0x65u, 0x72u, 0x03u, 0x03u, 0x11u, 0x18u, 0x00u, 0x00u,
...
CYBLE_GAP_BD_ADDR_T cyBle_deviceAddress = {{0x56u, 0x34u, 0x12u, 0x50u, 0xA0u, 0x00u}, 0x00u };
