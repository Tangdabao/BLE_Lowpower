...
#define CYBLE_GAP_ROLE_BROADCASTER                  (0u != (CYBLE_GAP_ROLE & CYBLE_GAP_BROADCASTER))
    ...
    #define CYBLE_FAST_ADV_TIMEOUT                  (0x7530u)
    ...
    #define CYBLE_FAST_SCAN_INTERVAL                (0x0640u)
    #define CYBLE_FAST_SCAN_WINDOW                  (0x0640u)
    #define CYBLE_FAST_SCAN_TIMEOUT                 (0x1964u)
    ...
    #define CYBLE_GAPC_CONNECTION_INTERVAL_MIN      (0x0028u)
    #define CYBLE_GAPC_CONNECTION_INTERVAL_MAX      (0x0038u)
